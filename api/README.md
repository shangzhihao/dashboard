...
- `GET /data/futures/calendar-spread/{category}/{nearContract}/{farContract}.json`
- `GET /data/futures/inter-commodity-spread/{leftCategory}/{leftContract}/{rightCategory}/{rightContract}.json`
- `GET /docs` (Swagger UI)
